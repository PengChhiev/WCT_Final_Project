...
export default function RegisterPage() {
  ...
  async function handleRegister(e) {
    ...
    try {
      ...
      // Every new account starts as "student". Promote to "moderator"
      // manually in the Firebase console (or via another moderator later).
  ...
  return (
    <section className="flex-1 flex items-center justify-center bg-gray-50 px-4 py-12">
      <div className="w-full max-w-md bg-white rounded-2xl border border-gray-200 p-8 shadow-sm">
        ...
        <p className="text-center text-sm text-gray-500 mb-6">Create a new student account</p>
